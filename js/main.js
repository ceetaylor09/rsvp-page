...
/* TO FIND PLACEHOLDER ATTRIBUTE IN IE 9 AND LOWER */
var _debug = false;
...
$("#rsvpSignup").validate({
	...
	errorPlacement: function(error, element) {
      	...
      	if (element.attr("name") == "EMAIL") {
        	$("#one").css("display" , "block").text("Please enter a valid email address");
        
        } else if (element.attr("name") == "FNAME") {
        	$("#two").css("display" , "block").text("Please enter your first name");

        } else if (element.attr("name") == "LNAME")  {
        	$("#three").css("display" , "block").text("Please enter your last name");
